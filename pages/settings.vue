...
<template>
    <div class="divide-y divide-gray-200 pt-8">
        <div class="px-6">
        <div>
            <h2 class="text-lg font-medium leading-6 text-gray-900">Application Settings</h2>
            <p class="mt-1 text-sm text-gray-500">
            These settings will be stored persistent on the machine and be still available after restart.
            </p>
        </div>
        <ul role="list" class="mt-2 divide-y divide-gray-200">
            ...
            <div class="flex flex-col">
                ...
                >If enabled, this application will start on each server restart automatically.</SwitchDescription
                >
            </div>
            <Switch
